<template>
	<view>
		...
		<view class="flex align-center fixed-top bg-white" style="height: 44px;">
			<!-- 搜索框 -->
			<input v-model="keyword" class="ml-2 flex align-center flex-1 rounded-circle px-1" style="background-color: #F6F7F8;color: #959FA0;" type="text" placeholder="音乐MV专辑：繁华梦"/>
			<view class="flex align-center px-2" style="color: #959FA0;" @click="handleSearch">搜索</view>
		</view>
